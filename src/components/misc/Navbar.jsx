...
import reduceToken from "../../pact/utils/reduceToken"
  ...
  return (
    <nav className="w-full flex flex-row justify-between items-center p-2 text-xl my-5">
      <div className="flex items-center justify-center gap-5 w-42">
        ...
        <button><a href="https://twitter.com"><img src="./images/twitter.png" className="w-12 rounded-full" /></a></button>
        <button><a href="https://discord.gg"><img src="./images/discord.png" className="w-12 rounded-full" /></a></button>
      </div>
      <div className={`text-3xl sm:text-6xl font-bold text-center md:text-6xl ${theme==='dark'?"text-white":""}`}> Coin Flip</div>
